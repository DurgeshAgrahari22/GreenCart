  ...
  return (
    <div className="mt-16">
        ...
        <div className="grid grid-cols sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 mt-6 gap-6">
        {
            ...
            return <div key={index} className="group cursor-pointer py-5 px-3 gap-2 rounded-lg flex flex-col justify-center items-center" 
            // second curly braces due to object
